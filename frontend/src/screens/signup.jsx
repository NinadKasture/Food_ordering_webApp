...
function Signup() {
    ...
    useEffect(()=>{
      ...
      const firebaseAuthentication = async (user) => {
        const response = await fetch("https://food-ordering-webapp.onrender.com/api/auth/oauth", {
            method: 'POST',
            headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://food-ordering-webapp.onrender.com/api/auth/register", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },

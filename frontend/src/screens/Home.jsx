...
function Home() {
  ...
  const loadFoodItems = async () => {
    let response = await fetch("https://food-ordering-webapp.onrender.com/api/data/foodData",{
      method: "GET",
      headers:{
  ...
  //     let response = await fetch("https://food-ordering-webapp.onrender.com/api/auth/google/data", {
  //       method: "GET",
  //       headers: {
  //         "Content-Type": "application/json",
  //       },
